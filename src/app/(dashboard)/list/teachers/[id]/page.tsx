      ...
      <div className="w-full xl:w-2/3">
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="bg-blue-400 py-6 px-4 rounded-md flex-1 flex gap-4">
            <div className="w-1/3">
              <Image
                src="https://msrit-bucket.s3.us-west-2.amazonaws.com/Gallery/hod/BPV-hod-AIDS.jpg"
                alt=""
                width={204}
                height={204}
            ...
            <div className="w-2/3 flex flex-col justify-between gap-4">
              <div className="flex items-center gap-4">
                <h1 className="text-xl font-semibold">Vijay Kumar</h1>
                {role === "admin" && <FormModel
                  ...
                  data={{
                    ...
                    sex: "male",
                    img: "https://msrit-bucket.s3.us-west-2.amazonaws.com/Gallery/hod/BPV-hod-AIDS.jpg",
                  }}
                />}
              </div>
              ...
              <div className="flex items-center justify-between gap-2 flex-wrap text-xs font-medium">
                ...
                <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2">
                  <Image src="/date.svg" alt="" width={20} height={20} />
